...
/**
 * "RECENT PROJECTS" section: heading plus a list of project rows.
 * Each row is a link with thumbnail, title/subtitle, and the orange
 * hover-swap arrow pinned to the top-right.
 */
      ...
      <div className="flex w-full flex-col">
        {projects.map((project) => (
          <a
            key={project.title}
            href={project.href}
            className="group relative flex w-full items-center justify-between overflow-hidden rounded-2xl px-4 py-5"
          >
            ...
            <span className="absolute right-4 top-9">
              <HoverArrow />
            </span>
          </a>
        ))}
